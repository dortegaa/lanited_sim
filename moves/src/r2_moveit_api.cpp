...
{
  const std::string node_name = "r2_moveit_api";
  ...
  robot_model_loader::RobotModelLoader robot_model_loader("robot2/robot_description");
  ...
  visual_tools.prompt("#1 Press 'next' in the RvizVisualToolsGui window to start the demo");
  ...
  /* We can also use visual_tools to wait for user input */
  visual_tools.prompt("#2 Press 'next' in the RvizVisualToolsGui window to continue the demo");

  // Joint Space Goals
  // ^^^^^^^^^^^^^^^^^
  // Now, setup a joint space goal
  moveit::core::RobotState goal_state(robot_model);
  std::vector<double> joint_values = { 0, -1.2, 1, -0.32, 1.81, 0 };
  ...
  /* Wait for user input */
  visual_tools.prompt("#3 Press 'next' in the RvizVisualToolsGui window to continue the demo");
  ...
  /* Wait for user input */
  visual_tools.prompt("#4 Press 'next' in the RvizVisualToolsGui window to continue the demo");
  ...
  // END_TUTORIAL
  /* Wait for user input */
  visual_tools.prompt("#5 Press 'next' in the RvizVisualToolsGui window to exit the demo");
